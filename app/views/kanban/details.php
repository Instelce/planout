...
<div class="kanban-grid">
    ...
    <?php foreach ($kanbanColumns as $column): ?>
        <div class="kanban-column" data-id="<?php echo $column->id ?>">
            <header>
                <h4><?php echo $column->name ?></h4>
<!--                <h4>--><?php //echo $column->name ." " . $column->id ?><!--</h4>-->
            </header>
            ...
            <div class="kanban-column-content">
                ...
                foreach ($cards as $card):
                    ...
                    <div class="kanban-card" draggable="true"
                        ...
                        data-kanban="<?php echo $kanbanBoard->id ?>">
                        <p><?php echo $card->content ?></p>
<!--                        <p>--><?php //echo $card->content . " " . $card->id . " " . $card->position ?><!--</p>-->
                    </div>
                <?php endforeach; ?>
            </div>
